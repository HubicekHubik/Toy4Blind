...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NORDIC_NRF21540_FEM_SPI_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESB_SYS_TIMER_INSTANCE, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_ONLY, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_NRF21540_GPIO_SPI, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_NRF21540_RUNTIME_PA_GAIN_CONTROL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_POWER_MODEL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_POWER_MODEL_NRF21540_USE_BUILTIN, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MPSL_FEM_BUILTIN_POWER_MODEL_UPDATE_PERIOD, 2000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF21540DK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NRF21540DK_NRF52840, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ESB_PTX_APP_LOG_LEVEL, 4);
